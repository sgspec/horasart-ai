...
"https://generativelanguage.googleapis.com/v1beta/models/gemini-3.1-flash-lite-preview:generateContent?key=" + env.GEMINI_KEY,

        {
          ...
          body: JSON.stringify({
            contents: [{
              parts: [{
text: "ทำนายฝัน '" + dream + "' สรุปแบบสั้นๆ พร้อมเลขมงคล 3 ตัว (เน้นเลขเด่น 1 ชุด และเลขรอง 2-3 ชุด) โดยไม่ต้องมีคำเกริ่นนำ และไม่ต้องมีประโยคคำถามหรือคำชวนคุยปิดท้าย"
